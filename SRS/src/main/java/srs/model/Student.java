...
public class Student extends Person {
	...
	public void addSection(Section s) {
		...
		s.getEnrolledStudents().put(this.getSsn(), this);
	}
	...
	public boolean isEnrolledIn(Section s) {
		for(Section section: attends){
			if(section.getSectionNo()==s.getSectionNo()) return true;
		}
		return false;
	}
	...
	public Boolean verfifyPlan(){
		return planOfStudy.verfifyPlan(this);
	}
